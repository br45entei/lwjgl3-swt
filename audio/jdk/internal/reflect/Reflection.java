...
public class Reflection {
	 ...
	 *             sun.misc.Reflection.getCallerClass. */
	...
	private static boolean isSameClassPackage(Class<?> c1, Class<?> c2) {
		if(c1.getClassLoader() != c2.getClassLoader()) return false;
	 ...
	 * is defined by either the bootstrap class loader or platform class
	 * loader. */
	...
	public static IllegalAccessException newIllegalAccessException(Class<?> currentClass, Class<?> memberClass, Class<?> targetClass, int modifiers) throws IllegalAccessException {
		...
		if(m1.isNamed()) currentSuffix = " (in " + m1 + ")";
		Module m2 = memberClass.getModule();
		if(m2.isNamed()) memberSuffix = " (in " + m2 + ")";
